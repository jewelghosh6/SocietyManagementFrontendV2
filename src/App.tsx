...
import ManageFlatsComp from "./pages/ManageFlatsComp";
import VisitorComp from "./pages/VisitorComp";
import VehicleComp from "./pages/VehicleComp";
import BillsComp from "./pages/BillsComp";
...
import SecurityComp from "./pages/SecurityComp";
import SignInPage from "./pages/SignInPage";
import SignUpPage from "./pages/SignUpPage";
import ForgetPasswordPage from "./pages/ForgetPasswordPage";
import NavBarForHome from "./components/NavBarForHome";
import ManageUsersComp from "./pages/ManageUsersComp";
...
import MyFlatDetailComp from "./pages/MyFlatDetailComp";
import MyBillsComp from "./pages/MyBillsComp";
